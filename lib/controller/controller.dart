...
class VideoController extends GetxController {
  ...
  Future initializePlayer(int i,BuildContext context) async {
    ...
    singleVideoController = VideoPlayerController.networkUrl(Uri.parse(Provider.of<VideosProvider>(context,listen: false).videosList[i].videoUrl.replaceAll('public', ApiConstants.baseUrl)));
  ...
  Future initializeIndexedController(int index,BuildContext context) async {
    late VideoPlayerController singleVideoController;
    singleVideoController = VideoPlayerController.network(
        Provider.of<VideosProvider>(context,listen: false).videosList[index].videoUrl.replaceAll('public', ApiConstants.baseUrl),
